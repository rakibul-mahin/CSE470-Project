...
const LeftSide = () => {
  ...
  return (
    <div className='mt-4 flex flex-col gap-3'>
      <div className='ml-7 flex flex-col gap-3 card bg-slate-900 items-center p-3 h-96 overflow-y-scroll'>
        <div>
          <p className='text-logo-text-green'>Others Activity</p>
        </div>
        {notifications.map((item) => (
      ...
      <div className='ml-7 flex flex-col gap-3 card bg-slate-900 items-center p-3 w-2/3'>
        <div className='text-logo-text-green'>
          <p>Explore</p>
        </div>
        <div className='h-96 carousel carousel-vertical rounded-box'>
